...
export const UPGRADES: UpgradeDef[] = [
  ...
  // EMOTIONAL — first DEPICT to reveal, ~3-4 min in
  {
    ...
    baseCost: 250, costGrowth: 1.16, costResource: 'attention', maxLevel: 30,
  ...
  // POLARIZATION — ~6 min
  {
    ...
    baseCost: 700, costGrowth: 1.16, costResource: 'attention', maxLevel: 30,
  ...
  // TROLLING — ~9 min
  {
    ...
    baseCost: 2000, costGrowth: 1.16, costResource: 'attention', maxLevel: 30,
  ...
  // CONSPIRACY — ~12 min
  {
    ...
    baseCost: 5000, costGrowth: 1.16, costResource: 'attention', maxLevel: 30,
  ...
  // DISCREDITING — ~15 min
  {
    ...
    baseCost: 12_000, costGrowth: 1.16, costResource: 'attention', maxLevel: 30,
    multiplier: { attention: 0.010 },
  ...
  // IMPERSONATION — last in Grassroots, ~18 min
  {
    ...
    baseCost: 30_000, costGrowth: 1.16, costResource: 'attention', maxLevel: 30,
...

  {
    ...
    baseCost: 100, costGrowth: 1.16, costResource: 'engagement', maxLevel: 30,
  ...
  },
  {
    ...
    baseCost: 150, costGrowth: 1.16, costResource: 'engagement', maxLevel: 30,
  ...
  },
  {
    ...
    baseCost: 200, costGrowth: 1.16, costResource: 'engagement', maxLevel: 30,
  ...
  },
  {
    ...
    baseCost: 250, costGrowth: 1.16, costResource: 'engagement', maxLevel: 30,
  ...
  },
  {
    ...
    baseCost: 130, costGrowth: 1.16, costResource: 'engagement', maxLevel: 30,
  ...
  },
  {
    ...
    baseCost: 90, costGrowth: 1.16, costResource: 'engagement', maxLevel: 30,
...
export const PROJECTS: ProjectDef[] = [
  ...
  },
  {
    ...
    cost: { attention: 20_000, engagement: 5000 },
    era: 'blog',
