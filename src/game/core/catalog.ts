...
export const ASSETS: AssetDef[] = [
  ...
  },
  {
    ...
    costResource: 'attention',
    produces: {},
    blurb: 'A script that fires posts automatically whenever a platform is charged. +10% post yield per copy owned.',
    precedents: [
      'Hootsuite, Buffer, SocialPilot — legitimate scheduling tools repurposed for sock-puppet networks.',
      'Cambridge Analytica auto-posted to ~30M Facebook users at scale via dark-posted ads (2016).',
      'Russian IRA used custom scripting (TweetDeck-like dashboards) to fire 100+ accounts per operator. (Senate Intel Vol. II)',
      'NameCheap "automation tools" forum threads — gray-market documentation of TikTok/X auto-post bots (Stanford IO 2023).',
      'Spamouflage Dragon: scripted Chinese-state network uses custom auto-post tooling across 50+ platforms simultaneously. (Graphika 2023)',
      'X "Creator Revenue Share" enabled paid auto-posters: bot-net operators monetized their AI-generated content via the program (CCDH 2023).',
    ],
    visible: (s) => s.resources.attention >= 1500,
    teased: (s) => s.resources.attention >= 800,
    teaseHint: 'Unlocks at 1.5K attention. Auto-fires posts on all charged platforms.',
  },
  {
    id: 'outlet',
...
export const UPGRADES: UpgradeDef[] = [
  ...
  // CONSPIRACY — ~12 min
  {
    ...
    // Conspiracy → engagement (long-tail, sticky audience).
    multiplier: { engagement: 0.015 },
  ...
  // DISCREDITING — ~15 min
  {
    ...
    // Discrediting also gets per-level cure suppression (cure.ts).
  ...
  // IMPERSONATION — last in Grassroots, ~18 min
  {
    ...
    // Impersonation → credibility (fake authority builds gravitas, not eyeballs).
    multiplier: { credibility: 0.010 },
...

  {
    ...
    baseCost: 10_000, costGrowth: 1.14, costResource: 'engagement', maxLevel: 30,
  ...
  },
  {
    ...
    baseCost: 15_000, costGrowth: 1.14, costResource: 'engagement', maxLevel: 30,
  ...
  },
  {
    ...
    baseCost: 25_000, costGrowth: 1.14, costResource: 'engagement', maxLevel: 30,
  ...
  },
  {
    ...
    baseCost: 13_000, costGrowth: 1.14, costResource: 'engagement', maxLevel: 30,
