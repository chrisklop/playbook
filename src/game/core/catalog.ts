...
export const UPGRADES: UpgradeDef[] = [
  ...
  // EMOTIONAL — first DEPICT to reveal, ~3-4 min in
  {
    ...
    baseCost: 25_000, costGrowth: 1.16, costResource: 'attention', maxLevel: 30,
    ...
    visible: (s) => s.resources.attention >= 20_000,
    teased: (s) => s.resources.attention >= 10_000,
    teaseHint: 'Unlocks at 20K attention.',
  },
  // POLARIZATION — ~6 min
  {
    id: 'polarization-1',
    ...
    baseCost: 70_000, costGrowth: 1.16, costResource: 'attention', maxLevel: 30,
    ...
    visible: (s) => s.resources.attention >= 60_000,
    teased: (s) => s.resources.attention >= 30_000,
    teaseHint: 'Unlocks at 60K attention.',
  },
  // TROLLING — ~9 min
  {
    id: 'trolling-1',
    ...
    baseCost: 200_000, costGrowth: 1.16, costResource: 'attention', maxLevel: 30,
    ...
    visible: (s) => s.resources.attention >= 180_000,
    teased: (s) => s.resources.attention >= 100_000,
    teaseHint: 'Unlocks at 180K attention.',
  },
  // CONSPIRACY — ~12 min
  {
    id: 'conspiracy-1',
    ...
    baseCost: 500_000, costGrowth: 1.16, costResource: 'attention', maxLevel: 30,
    ...
    visible: (s) => s.resources.attention >= 450_000,
    teased: (s) => s.resources.attention >= 250_000,
    teaseHint: 'Unlocks at 450K attention.',
  },
  // DISCREDITING — ~15 min
  {
    id: 'discrediting-1',
    ...
    baseCost: 1_200_000, costGrowth: 1.16, costResource: 'attention', maxLevel: 30,
    multiplier: { attention: 0.010 },
    ...
    visible: (s) => s.resources.attention >= 1_100_000,
    teased: (s) => s.resources.attention >= 600_000,
    teaseHint: 'Unlocks at 1.1M attention.',
  },
  // IMPERSONATION — last in Grassroots, ~18 min
  {
    ...
    baseCost: 3_000_000, costGrowth: 1.16, costResource: 'attention', maxLevel: 30,
    ...
    visible: (s) => s.resources.attention >= 2_800_000,
    teased: (s) => s.resources.attention >= 1_500_000,
    teaseHint: 'Unlocks at 2.8M attention.',
  },
...
export const PROJECTS: ProjectDef[] = [
  {
    ...
    visible: (s) => s.resources.attention >= 60_000 && !s.completedProjects['editorial-calendar'],
    teased: (s) => s.resources.attention >= 30_000 && !s.completedProjects['editorial-calendar'],
    teaseHint: 'A paradigm project. Unlocks at 60K attention.',
    effect: (s) => {
